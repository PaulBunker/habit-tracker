...
describe('HabitItem', () => {
  ...
  describe('Card view (not expanded)', () => {
    ...
    it('expands when card clicked (not checkbox)', async () => {
      render(
        <HabitItem
          habit={mockHabit}
          isExpanded={false}
      ...
      // Click on the habit name (not the checkbox)
      const habitName = screen.getByText('Test Habit');
